...
# python ~/code/alex-combo/get_log.py --prefix /mnt/nlpunilm/alex/ft_logs --ckp-prefix /mnt/nlpunilm/alex/ckps --folders main,grep,qk96,hploss --mean --step 125 --output /tmp/r.txt
