...
mkdir -p $OUTPUT_PATH
echo $OUTPUT_PATH
LANGS="ar,cs,de,en,es,et,fi,fr,gu,hi,it,ja,kk,ko,lt,lv,my,ne,nl,ro,ru,si,tr,vi,zh,af,az,bn,fa,he,hr,id,ka,km,mk,ml,mn,mr,pl,ps,pt,sv,sw,ta,te,th,tl,uk,ur,xh,gl,sl"
...
python train.py $DATA_DIR \
    ...
    --lang-pairs $LANG_PAIRS --langs $LANGS --encoder-normalize-before --decoder-normalize-before \
    ...
    --max-source-positions ${MAX_SOURCE_LEN} --max-target-positions ${MAX_TARGET_LEN} \
    --truncate-source \
    ...
    --save-interval-updates 1000000 --start-save-epoch 1 \
    --fp16 --fp16-init-scale 4 --ddp-backend=no_c10d ${EXTRA_CMDS}
