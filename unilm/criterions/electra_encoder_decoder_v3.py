...
@dataclass
class ElectraV3Config(UniLmConfig):
    mlm_only: bool = field(
...
@register_criterion("electra_encoder_decoder_v3", dataclass=ElectraV3Config)
class ElectraEncoderDecoderV3Loss(FairseqCriterion):
    """
    ...
    def seq2seq_loss(self, model, sample, reduce, update_num=-1):
        ...
        logging_output = {
            ...
            "inconsistency_generator_loss": inconsistency_generator_loss if self.tpu else inconsistency_generator_loss.data * self.cfg.inconsistency_weight,
