...
@dataclass
class Electrav5Config(UniLmConfig):
    mlm_only: bool = field(
...
@register_criterion("electra_encoder_decoder_v5", dataclass=Electrav5Config)
class ElectraEncoderDecoderv5Loss(FairseqCriterion):
    """
