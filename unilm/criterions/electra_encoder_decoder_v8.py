...
@dataclass
class Electrav8Config(UniLmConfig):
    mlm_only: bool = field(
...
@register_criterion("electra_encoder_decoder_v8", dataclass=Electrav8Config)
class ElectraEncoderDecoderv8Loss(FairseqCriterion):
    """
