...
@dataclass
class ElectraEncoderDecoderConfig(FairseqDataclass):
...
class ElectraEncoder(TransformerEncoderBase):
    def __init__(
            self,
            args,
            dictionary,
...
@register_model("electra_encoder_decoder")
class ElectraEncoderDecoder(TransformerModel):
    """
    ...
    def add_args(cls, parser):
        ...
        gen_parser_from_dataclass(
            parser, ElectraEncoderDecoderConfig(), delete_default=True, with_prefix=""
        )
...
@register_model_architecture("electra_encoder_decoder", "electra_encoder_decoder")
def electra_encoder_decoder_architecture(args):
...
def base_electra_encoder_decoder_architecture(args):
    electra_encoder_decoder_architecture(args)


@register_model_architecture("electra_encoder_decoder", "electra_encoder_decoder_large")
