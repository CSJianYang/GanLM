...
@dataclass
class ElectraEncoderDecoderConfigv4(FairseqDataclass):
...
class ElectraEncoderv4(TransformerEncoderBase):
    def __init__(
            self,
            args,
            dictionary,
...
class ElectraDecoderv4(UniLMDecoder):
    """
    Transformer decoder consisting of *cfg.decoder.layers* layers. Each layer
    is a :class:`TransformerDecoderLayer`.
...
@register_model("electra_encoder_decoder_v4")
class ElectraEncoderDecoderv4(TransformerModel):
    """
    ...
    def add_args(cls, parser):
        ...
        gen_parser_from_dataclass(
            parser, ElectraEncoderDecoderConfigv4(), delete_default=False, with_prefix=""
        )
    ...
    def build_model(cls, args, task):
        ...
        base_electra_encoder_decoder_architecture_v4(args)
    ...
    def build_encoder(cls, cfg, src_dict, embed_tokens):
        ...
        return ElectraEncoderv4(wrapper_cfg, src_dict, embed_tokens)


    @classmethod
    def build_decoder(cls, cfg, tgt_dict, embed_tokens):
        return ElectraDecoderv4(
            cfg,
            tgt_dict,
            embed_tokens,
...
@register_model_architecture("electra_encoder_decoder_v4", "electra_encoder_decoder_v4")
def electra_encoder_decoder_architecture_v4(args):
...
@register_model_architecture("electra_encoder_decoder_v4", "electra_encoder_decoder_v4_base")
def base_electra_encoder_decoder_architecture_v4(args):
    electra_encoder_decoder_architecture_v4(args)


@register_model_architecture("electra_encoder_decoder_v4", "electra_encoder_decoder_v4_large")
