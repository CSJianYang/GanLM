...
@dataclass
class ElectraEncoderDecoderConfigv5(FairseqDataclass):
...
class ElectraEncoderv5(TransformerEncoderBase):
    def __init__(
            self,
            args,
            dictionary,
...
class ElectraDecoderv5(UniLMDecoder):
    """
    Transformer decoder consisting of *cfg.decoder.layers* layers. Each layer
    is a :class:`TransformerDecoderLayer`.
...
@register_model("electra_encoder_decoder_v5")
class ElectraEncoderDecoderv5(TransformerModel):
    """
    ...
    def add_args(cls, parser):
        ...
        gen_parser_from_dataclass(
            parser, ElectraEncoderDecoderConfigv5(), delete_default=False, with_prefix=""
        )
    ...
    def build_model(cls, args, task):
        ...
        base_electra_encoder_decoder_architecture_v5(args)
    ...
    def build_encoder(cls, cfg, src_dict, embed_tokens):
        ...
        return ElectraEncoderv5(wrapper_cfg, src_dict, embed_tokens)


    @classmethod
    def build_decoder(cls, cfg, tgt_dict, embed_tokens):
        return ElectraDecoderv5(
            cfg,
            tgt_dict,
            embed_tokens,
...
@register_model_architecture("electra_encoder_decoder_v5", "electra_encoder_decoder_v5")
def electra_encoder_decoder_architecture_v5(args):
...
@register_model_architecture("electra_encoder_decoder_v5", "electra_encoder_decoder_v5_base")
def base_electra_encoder_decoder_architecture_v5(args):
    electra_encoder_decoder_architecture_v5(args)


@register_model_architecture("electra_encoder_decoder_v5", "electra_encoder_decoder_v5_large")
