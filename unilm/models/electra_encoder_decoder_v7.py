...
@dataclass
class ElectraEncoderDecoderConfigv7(FairseqDataclass):
...
class ElectraEncoderv7(TransformerEncoderBase):
    def __init__(
            self,
            args,
            dictionary,
...
class ElectraDecoderv7(UniLMDecoder):
    """
    Transformer decoder consisting of *cfg.decoder.layers* layers. Each layer
    is a :class:`TransformerDecoderLayer`.
...
@register_model("electra_encoder_decoder_v7")
class ElectraEncoderDecoderv7(TransformerModel):
    """
    ...
    def add_args(cls, parser):
        ...
        gen_parser_from_dataclass(
            parser, ElectraEncoderDecoderConfigv7(), delete_default=False, with_prefix=""
        )
    ...
    def build_model(cls, args, task):
        ...
        base_electra_encoder_decoder_architecture_v7(args)
    ...
    def build_encoder(cls, cfg, src_dict, embed_tokens):
        ...
        return ElectraEncoderv7(wrapper_cfg, src_dict, embed_tokens)


    @classmethod
    def build_decoder(cls, cfg, tgt_dict, embed_tokens):
        return ElectraDecoderv7(
            cfg,
            tgt_dict,
            embed_tokens,
...
@register_model_architecture("electra_encoder_decoder_v7", "electra_encoder_decoder_v7")
def electra_encoder_decoder_architecture_v7(args):
...
@register_model_architecture("electra_encoder_decoder_v7", "electra_encoder_decoder_v7_base")
def base_electra_encoder_decoder_architecture_v7(args):
    electra_encoder_decoder_architecture_v7(args)


@register_model_architecture("electra_encoder_decoder_v7", "electra_encoder_decoder_v7_large")
