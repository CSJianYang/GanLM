...
from fairseq.modules import transformer_layer, TransformerEncoderLayer
...
# architectures
@register_model_architecture("t5_transformer", "t5_transformer")
def t5_transformer_base_architecture(args):
...
@register_model_architecture("t5_transformer", "t5_transformer_big")
def t5_transformer_big(args):
