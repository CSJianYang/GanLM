...
@register_task("summarization_multi_simple_epoch")
class SummarizationMultiSimpleEpochTask(LegacyFairseqTask):
    @staticmethod
    def add_args(parser):
    ...
    @classmethod
    def load_dictionary(cls, filename, extra_mask_tokens=True, required_batch_size_multiple=1):
